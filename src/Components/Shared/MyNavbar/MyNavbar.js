        ...
        <Navbar variant="dark" bg="dark" expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    ...
                    <Nav.Link as={Link} to="/dashboard/bookings" className="navLink">
                       Orders
                    </Nav.Link>
                    <Nav.Link as={Link} to={`/dashboard/book/${id}`} className="navLink">
                        Book
                    </Nav.Link>
                    <Nav.Link as={Link} to="/home" className="navLink">
                        Login
                    ...
                    <Nav.Link as={Link} to="/dashboard/giveReview" className="navLink">
                        Feedback
                    </Nav.Link>
                </Nav>
            </Navbar.Collapse>
